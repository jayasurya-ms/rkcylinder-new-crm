    ...
    <div className="p-4 space-y-6 text-foreground">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button onClick={handlePrint} disabled={data.length === 0} variant="destructive" className="gap-2">
      ...
      <div ref={reportRef} className="bg-white rounded-lg p-2 overflow-hidden text-black">
        <h2 className="hidden print:block text-2xl font-bold text-center mb-4 uppercase">{reportType.replace('report', 'Report ')}</h2>
        <DataTable
          data={data}
          columns={columns}
          loading={loading}
